...
function makeView(overrides: Partial<AssetGenerateView> = {}): AssetGenerateView {
  return {
  ...
  it("isolates assets across turn ids", () => {
    fakeSessionState.current = {
      ...
      assetsByTurn: new Map([
        ...
        ["turn-B", [
          makeView({ id: "b1", modality: "audio", ref: { id: "0".repeat(64), mime: "audio/wav", size: 4 } }),
          makeView({ id: "b2", modality: "audio", ref: { id: "f".repeat(64), mime: "audio/wav", size: 4 } }),
        ]],
      ]),
    };
