...
const TABS: TabDef[] = [
  { id: "geography", labelKey: "world.geography", icon: <MapPin className="h-4 w-4" /> },
  { id: "factions", labelKey: "world.factions", icon: <Users className="h-4 w-4" /> },
  { id: "powerSystem", labelKey: "world.powerSystem", icon: <Zap className="h-4 w-4" /> },
  { id: "history", labelKey: "world.history", icon: <Clock className="h-4 w-4" /> },
  { id: "economy", labelKey: "world.economy", icon: <Coins className="h-4 w-4" /> },
  { id: "socialStructure", labelKey: "world.socialStructure", icon: <Building2 className="h-4 w-4" /> },
  { id: "tone", labelKey: "world.tone", icon: <Palette className="h-4 w-4" /> },
  { id: "mechanics", labelKey: "world.mechanics", icon: <Gamepad2 className="h-4 w-4" /> },
  { id: "startingConditions", labelKey: "world.startingConditions", icon: <Flag className="h-4 w-4" /> },
];
        ...
        <Tabs defaultValue="geography" className="flex flex-col h-full">
          ...
          <ScrollArea className="flex-1 mt-4">
            <TabsContent value="geography">
              <GeographyTab dimensions={dimensions} onChange={setDimensions} t={t} />
            </TabsContent>
            <TabsContent value="factions">
              <FactionsTab dimensions={dimensions} onChange={setDimensions} t={t} />
            </TabsContent>
            <TabsContent value="powerSystem">
              <PowerSystemTab dimensions={dimensions} onChange={setDimensions} t={t} />
            </TabsContent>
            <TabsContent value="history">
              <HistoryTab dimensions={dimensions} onChange={setDimensions} t={t} />
            </TabsContent>
            <TabsContent value="economy">
              <EconomyTab dimensions={dimensions} onChange={setDimensions} t={t} />
            </TabsContent>
            <TabsContent value="socialStructure">
              <SocialStructureTab dimensions={dimensions} onChange={setDimensions} t={t} />
            </TabsContent>
            <TabsContent value="tone">
              <ToneTab dimensions={dimensions} onChange={setDimensions} t={t} />
            </TabsContent>
            <TabsContent value="mechanics">
              <MechanicsTab dimensions={dimensions} onChange={setDimensions} t={t} />
            </TabsContent>
            <TabsContent value="startingConditions">
              <StartingConditionsTab dimensions={dimensions} onChange={setDimensions} t={t} />
            </TabsContent>
          </ScrollArea>
        </Tabs>
      </CardContent>
