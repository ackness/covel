/**
 * V2 Turn routes — execute player turns via TurnExecutor.
 */
...
// POST /v2/session/:id/turn — Execute a player turn
...
// GET /v2/session/:id/results — Get most recent turn results
...
// GET /v2/session/:id/turns — Get turn history
