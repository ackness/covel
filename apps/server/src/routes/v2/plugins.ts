/**
 * V2 Plugin routes — list, configure, enable/disable plugins.
 */
...
// GET /v2/plugins — List all loaded plugins
...
// GET /v2/plugins/:id — Get plugin details
...
// GET /v2/plugins/:id/config — Get plugin config schema + values
...
// PATCH /v2/plugins/:id/config — Update plugin config
