/**
 * API State routes — query session state tables and change history.
 *
...
// GET /session/:id/state — Get all state tables
...
// GET /session/:id/state/:table — Get table snapshot
...
// GET /session/:id/state/:table/:field/history — Get field change history
