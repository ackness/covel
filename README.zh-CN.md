...
> **当前公开版本：v0.0.15**，早期阶段 —— API、数据格式、插件 frontmatter 可能随版本变化。官方预编译包面向 macOS Apple Silicon 与 Windows x64，其余平台从源码构建。
...
- 🧩 **一切皆插件** —— 内置 20 个 agent。一个插件就是一份 `PLUGIN.md`：YAML frontmatter 声明触发/工具/事件，Markdown 正文就是 agent 的提示词。
