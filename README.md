...
[![Version](https://img.shields.io/badge/version-v0.0.37-8b5cf6)](https://github.com/ackness/covel/releases/tag/v0.0.37)
...
> **Release version: v0.0.37**, early access. APIs, world data, and plugin manifests may change between versions. Current binaries target macOS Apple Silicon and Windows x64 and are unsigned; read [`docs/CHANGELOG.md`](./docs/CHANGELOG.md) and back up custom content before upgrading.
