...
[![Version](https://img.shields.io/badge/version-v0.0.11-8b5cf6)](https://github.com/ackness/covel/releases/tag/v0.0.11)
...
> **Current public release: v0.0.11**, early access — APIs, data formats, and plugin frontmatter may change between versions. Prebuilt binaries target macOS Apple Silicon; other platforms build from source.
