...
[![Version](https://img.shields.io/badge/version-v0.0.25-8b5cf6)](https://github.com/ackness/covel/releases/tag/v0.0.25)
...
> **Current public release: v0.0.25**, early access — APIs, data formats, and plugin frontmatter may change between versions. Prebuilt binaries target macOS Apple Silicon and Windows x64; other platforms build from source.
