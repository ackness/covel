...
- `apps/server/src/routes/api/bootstrap.ts`: 874 lines
...
| -------- | -------------------------------------------------------------------: | --------: | ------------------------------------------------------- | ------------------------------------ |
| 1        |                            `apps/server/src/routes/api/bootstrap.ts` |       874 | tool bootstrap, compactor and memory setup              | Server bootstrap and API route tests |
...
- `bootstrap.ts` still owns tool registration, compactor setup, and memory setup. Future passes should split one subsystem at a time and preserve bootstrapApi as the composition root.
