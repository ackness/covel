...
| LLM tools                    | [`tools.md`](tools.md)                                     | `packages/tools/src/`, `packages/runtime/src/turn-agent-tool-loop.ts`, `packages/runtime/src/turn-function-runtime.ts`             |
...
| Prompt structure             | [`prompt-structure.md`](prompt-structure.md)               | `packages/context/src/`, `packages/runtime/src/turn-runtime-execution.ts`, `packages/runtime/src/turn-executor/session-context.ts` |
