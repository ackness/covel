...
- Do not copy meta wording from the concept into the setting. Never describe world content as a test or validation fixture, a prompt or model output, an e2e/API example, or an internal framework artifact.
