...
export const worldGeographySchema = z.object({
...
export const worldFactionSchema = z.object({
  id: z.string().min(1).regex(/^[a-z][a-z0-9-]*$/, {
    message: 'faction id must be lowercase with hyphens (e.g. "dark-guild")',
  }),
  name: i18nTextSchema,
  description: i18nTextSchema,
...
export const powerTierSchema = z.object({
  name: i18nTextSchema,
  rank: z.number().int().min(1),
  description: i18nTextSchema.optional(),
}).strict();

export const worldPowerSystemSchema = z.object({
  name: i18nTextSchema,
...
export const worldCurrencySchema = z.object({
  name: i18nTextSchema,
...
export const socialClassSchema = z.object({
  name: i18nTextSchema,
  description: i18nTextSchema,
  rank: z.number().int().optional(),
}).strict();

export const worldRaceSchema = z.object({
  name: i18nTextSchema,
  description: i18nTextSchema,
  traits: z.array(i18nTextSchema).optional(),
}).strict();

export const worldSocialStructureSchema = z.object({
...
export const worldToneSchema = z.object({
...
export const combatStyleSchema = z.enum(['turn-based', 'real-time', 'narrative', 'none']);
export const difficultyLevelSchema = z.enum(['easy', 'normal', 'hard', 'adaptive']);

export const worldMechanicsSchema = z.object({
...
export const worldStartingConditionsSchema = z.object({
