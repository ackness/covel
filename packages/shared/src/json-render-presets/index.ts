...
export function createGalleryPreset(options?: GalleryPresetOptions): JsonRenderPanelPreset {
  return {
...
export function createJobsPreset(options?: JobsPresetOptions): JsonRenderPanelPreset {
  return {
