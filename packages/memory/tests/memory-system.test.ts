...
const currentBlocks: CoreMemoryBlock[] = [
  { label: 'story_state', content: '初始状态', updatedAt: '2026-01-01T00:00:00Z' },
  ...
  { label: 'player_profile', content: '玩家资料', updatedAt: '2026-01-01T00:00:00Z' },
];
    ...
    const system = createMemorySystem(
      {
        store: store as any,
        llm,
        resolveSlot: (slot) => (slot === 'memory' || slot === 'story' ? slot : undefined),
      },
      {
